...
#
#  $ bin/test -s rer.search -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rer.search.testing.RER_SEARCH_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rer/search/tests/robot/test_example.robot
#
